...
export default function Home() {
  return (
    ...
    {/* Metadata */}
      ...
      <main>
        <div className="w-full px-4 h-full flex flex-col gap-y-4 sm:justify-center sm:w-3/4 items-center">
            <PitchGenerator/>
              ...
              <ul className="w-full">
                <li className="flex" style={{marginBottom: "0.75em"}}>
                  ...
                  <p className="align-middle mr-2">
                    {`Make sure to include both the current website URL as well the site's creator "Caleb Landry" \
                    in the content the diagram is to be used in.`}
                  </p>
                ...
                <li className="flex">
                  ...
                  <p className=" align-middle mr-2">
                    {`Any derivation of the diagrams created using the pitch generator must \
                    also be distributed under the same license specified here.`}
                  </p>
                ...
                <p className="w-full">
                  {`Note that this license does not apply to the software used to create the \
                  pitch diagrams which is copywrited by creator of the site.`}
                </p>
              </span>
          </div>
      </main>
